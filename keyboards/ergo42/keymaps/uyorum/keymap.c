...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |TenKey| LGUI |AltTab| LAlt |Ctrl/\| Space| Meta1|   | Meta2| Space|RSft/-|   ^  | LEFT | RIGHT| DOWN |
   * `------------------------------------------------'   `------------------------------------------------'
   */
    ...
    TG(TENKEY), KC_LGUI, ALT_TAB, KC_LALT, CTL_T(KC_JYEN), KC_SPC, LT(META1, KC_F19), LT(META2, KC_F20), KC_SPC, RSFT_T(KC_MINS), KC_EQL, KC_LEFT, KC_RGHT, KC_DOWN \
    ),
